...
<head>
    ...
    <title>Cek Khodam By Surya</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@10">
    <style>
        body {
            background-color: rgba(0, 76, 229, 0.9); /* Background lebih gelap */
        ...
        .card {
            background-color: rgba(57, 0, 215, 0.25);
            padding: 20px;
            border: 1px solid #000000; /* Border jingga ke kuningan */
            border-radius: 10px;
            width: 100%;
            max-width: 500px;
        ...
        h1, p {
            color: #fffafbc1; /* Warna font jingga ke kuningan */
            margin-bottom: 20px;
        }
        ...
        input[type="text"] {
            padding: 10px;
            font-size: 16px;
            border: 2px solid #000000; /* Border input */
            border-radius: 200px;
            text-align: center;
            width: 80%;
            margin-bottom: 20px;
